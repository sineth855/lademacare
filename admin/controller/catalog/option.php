	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($options as $option) {
				...
				if ($option['type'] == 'select' || $option['type'] == 'table' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'image') {
				...
				if ($option['type'] == 'select' || $option['type'] == 'table' || $option['type'] == 'radio' || $option['type'] == 'checkbox') {
