...
<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="patch">
...
?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo getSelectHtml('font_family', $font_family, listfonts('barcodegen/font')); ?> 
                            <?php echo getInputTextHtml('font_size', $font_size, array('type' => 'number', 'min' => 1, 'max' => 30)); ?>
